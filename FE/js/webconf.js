window.onload = function() {
  ...
  btnLogin.addEventListener("click", function() {
    ...
    window.location.replace("admin/cursos-profissionais.html")  



    swal({
      title: "Acesso à área de gestão dos Cursos Profissionais",
      html:
...
function myMap() {
  ...
  // Ponto no mapa a localizar (cidade de Vila Franca de Xira)
  //const porto = new google.maps.LatLng(41.14961  , -8.61099)
  const vfx = new google.maps.LatLng(38.9546457  , -9.0030989)
